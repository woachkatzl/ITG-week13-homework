...
if (number >= 0) {
    console.log("Переменная является положительным числом или нулём")
} else {
    console.log("Переменная не является положительным числом или нулём")
}
...
if (number % 5 === 0 || number % 7 === 0) {
    ...
    console.log("Переменная не является кратной 5 или 7")
}
...
if (number <= 0) {
    console.log("Переменная является отрицательным числом или нулём")
} else {
    console.log("Переменная не является отрицательным числом или нулём")
}
...
switch (direction) {
    ...
    case "W":
        ...
        break;
    default:
        console.log("Введите символ напрвления: N, S, E, или W");
}
